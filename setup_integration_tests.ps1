Param($url,$uploadUrl, $privateKey)
...
$uploadsUrlNode = $doc.SelectSingleNode('configuration/appSettings/add[@key="uploads_test_url"]')
$uploadsUrlNode.Attributes['value'].Value = $uploadUrl
